...
#ifdef CONFIG_MTK_LENS_OV5648MIPIAF_SUPPORT
extern void OV5648MIPIAF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened);
extern long OV5648MIPIAF_Ioctl(struct file *a_pstFile, unsigned int a_u4Command, unsigned long a_u4Param);
extern int OV5648MIPIAF_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
