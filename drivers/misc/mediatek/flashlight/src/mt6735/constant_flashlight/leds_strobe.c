...
extern int flashlight_gpio_enable_high(void);
extern int flashlight_gpio_enable_low(void);
extern int flashlight_gpio_mode_high(void);
extern int flashlight_gpio_mode_low(void);

/* #define FLASH_GPIO_ENF GPIO12 */
/* #define FLASH_GPIO_ENT GPIO13 */

//Elink Nicholas Zheng add begin ----------------------------------------------
/*static unsigned int FLASH_GPIO_MODE;
static unsigned int FLASH_GPIO_ENABLE;*/



/*static void FL_set_gpio_output(unsigned int GPIO, unsigned int output)
{
...
{    
    printk("FL_Flash_Mode\n");
    //FL_set_gpio_output(FLASH_GPIO_MODE,1);
    flashlight_gpio_mode_high();
}

void FL_Torch_Mode(void)
{    
    printk("FL_Torch_Mode\n");
    //FL_set_gpio_output(FLASH_GPIO_MODE,0);
    flashlight_gpio_mode_high();
}

void FL_get_gpio_infor(void)
{
	static struct device_node *node;

	printk("%s() Start \n", __func__);
	
	node = of_find_compatible_node(NULL, NULL, "mediatek,flashlight");
	
	if (!node)
		printk("([Elink] [Flashlight] Failed to find device-tree node: %s\n", __func__);
	
	
/*	FLASH_GPIO_MODE = of_get_named_gpio(node, "flash_gpio_mode", 0);
	FLASH_GPIO_ENABLE = of_get_named_gpio(node, "flash_gpio_enable", 0);*/
}
...
{
//Elink Nicholas Zheng add begin ----------------------------------------------
	//FL_set_gpio_output(FLASH_GPIO_ENABLE,1);
...
{
//Elink Nicholas Zheng add begin  ----------------------------------------------
	//FL_set_gpio_output(FLASH_GPIO_ENABLE,0);
