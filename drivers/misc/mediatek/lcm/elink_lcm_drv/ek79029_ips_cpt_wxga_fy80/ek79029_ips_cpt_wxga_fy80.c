...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_frontporch = 12;  // 12 
	params->dsi.vertical_active_line = FRAME_HEIGHT;

	params->dsi.horizontal_sync_active =25; // 25; 
	params->dsi.horizontal_backporch =	25; // 25
	params->dsi.horizontal_frontporch = 25; // 25; 
...
static void init_lcm_registers(void)
{
	...
	data_array[0] = 0x68411500;   // 3b 46 51 60 26 2B 31 36 3b 40
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0] = 0x84611500; // 50
	dsi_set_cmdq(data_array, 1, 1);
	
	data_array[0] = 0x504e1500; // 50
	dsi_set_cmdq(data_array, 1, 1);
	data_array[0] = 0x4f4f1500;//55
	dsi_set_cmdq(data_array, 1, 1);
	
	//data_array[0] = 0x74611500;	 //++++++++++++++ 84
	//dsi_set_cmdq(data_array, 1, 1);
	data_array[0] = 0x04631500;   //3lane 24 4lane 04
	dsi_set_cmdq(data_array, 1, 1);
...
void ek79029_ips_cpt_early_init_lcm(void)
{
...
static void lcm_init(void)
{
	...
	//lcm_get_gpio_infor();
	ek79029_ips_cpt_early_init_lcm();
...
LCM_DRIVER ek79029_ips_cpt_wxga_fy80_lcm_drv = 
{
    .name			= "ek79029_ips_cpt_wxga_fy80",
