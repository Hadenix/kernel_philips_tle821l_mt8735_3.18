...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_sync_active				= 4; //12; //12; //2;//4; //10;
	params->dsi.vertical_backporch					= 14; //60; //60; //8;//4; //20;	
	params->dsi.vertical_frontporch 				= 8; //200;//100;//200; //8; //20;
	params->dsi.vertical_active_line				= FRAME_HEIGHT; 

	params->dsi.horizontal_sync_active				= 4; //16; //20;
	params->dsi.horizontal_backporch				= 64; //72;  //spec not describe?
	params->dsi.horizontal_frontporch				= 16; //176;
...
void otm1284_hd720_early_init_lcm(void)
{
...
LCM_DRIVER otm1284_hd720_dsi_vdo_tm_lcm_drv = 
{
    .name			= "otm1284_hd720_dsi_vdo_tm",
