...
//HSD5.94+HX8389C	20140723	
	...
	data_array[1]=0x15157fB1; //data_array[1]=0x101064B1; 
	data_array[2]=0xd0503535; 
	data_array[3]=0x208052ec;
	data_array[4]=0xaaaaf820;//data_array[4]=0x2201F8B8;
	...
	data_array[1]=0x0d5080B2;
	data_array[2]=0x11384007; //0x11380007; 
	data_array[3]=0x00095d64;  
	dsi_set_cmdq(data_array, 4, 1); 
	MDELAY(1); 

	data_array[0]=0x000c3902;
	data_array[1]=0x207710B4; 
	data_array[2]=0x10000077; //0x10360566; 
	data_array[3]=0xc0784078;
	...
	data_array[2]=0x0008183c; //0x00080000; 
	data_array[3]=0x00041032; 
	data_array[4]=0x00000004; 
	data_array[5]=0x00000000; 
	data_array[6]=0x08003300; //0x08333700; 
	data_array[7]=0x00003708;
	data_array[8]=0x00000f00; 
	data_array[9]=0x01000a00; //0x01000A00; 
	//data_array[10]=0x000100a; 
	...
	data_array[3]=0x0218181b; 
	data_array[4]=0x00181803; 
	data_array[5]=0x06181801; 
	data_array[6]=0x04181807; 
	...
	data_array[3]=0x0518181b; 
	data_array[4]=0x07181804; 
	data_array[5]=0x01181806; 
	data_array[6]=0x03181800;		 
	...
	data_array[3]=0x0d0b073f; 
	data_array[4]=0x14120e17; 
	data_array[5]=0x12081412; 
	data_array[6]=0x1a001714;		 
	data_array[7]=0x3f322d1e;
	data_array[8]=0x0b074028; 
	data_array[9]=0x13110f18; 
	data_array[10]=0x11071312; 
	data_array[11]=0x00001218; 
...
void hx8389c_hsd_qhd_early_init_lcm(void)
{
...
static void lcm_init(void)
{
	...
	//lcm_get_gpio_infor();
	hx8389c_hsd_qhd_early_init_lcm();
...
LCM_DRIVER hx8389c_hsd_qhd_dsi_vdo_lcm_drv = 
{
    .name			= "hx8389c_hsd_qhd_dsi_vdo",
