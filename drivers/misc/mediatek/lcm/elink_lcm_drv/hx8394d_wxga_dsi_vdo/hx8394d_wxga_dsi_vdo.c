...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.horizontal_sync_active = 36; //4;
	params->dsi.horizontal_backporch =	80; //80; //64; //42;  //50;
	params->dsi.horizontal_frontporch = 80; //80; //16; //16; //44; //60;
...
MDELAY(5);
	...
	data_array[4]= 0x6F606F6E;
	data_array[5]= 0x01606F60;
...
MDELAY(5);
	...
	data_array[2]= 0x273B302D;   //14 --
	data_array[3]= 0x0D0B0840;   //14 --> 
	data_array[4]= 0x15120F18;   //	70--7a
...
LCM_DRIVER hx8394d_wxga_dsi_vdo_lcm_drv = 
{
	.name = "hx8394d_wxga_dsi_vdo",
