...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.LANE_NUM				= LCM_TWO_LANE;//LCM_TWO_LANE;LCM_FOUR_LANE
...
// 索灵 540*960,  ivo 玻璃, HC8389C
	...
	data_array[1]=0x14147FB1; 
	data_array[2]=0xD0903535; 
	...
	data_array[1]=0x125080B2; 
	data_array[2]=0x1138000F; 
	data_array[3]=0x00095C64; 
	dsi_set_cmdq(data_array, 4, 1);
	MDELAY(1); 
	
	data_array[0]=0x000B3902;
	data_array[1]=0x767676B4; 
	data_array[2]=0x10000076; 
	data_array[3]=0x00822482; 
	dsi_set_cmdq(data_array, 4, 1);
	MDELAY(1); 
	...
	data_array[4]=0x03CC0308; 
	data_array[5]=0x000000CC; 
	data_array[6]=0x0A044700; 
	data_array[7]=0x0000470A; 
...
void hx8389c_ivo_qhd_sl_early_init_lcm(void)
{
...
static void lcm_init(void)
{
	...
	//lcm_get_gpio_infor();
	hx8389c_ivo_qhd_sl_early_init_lcm();
...
LCM_DRIVER hx8389c_ivo_qhd_dsi_vdo_sl_lcm_drv = 
{
    .name			= "hx8389c_ivo_qhd_dsi_vdo_sl",
