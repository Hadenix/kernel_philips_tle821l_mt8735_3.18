...
static void init_lcm_registers(void)
{
	...
	*/
	...
	data_array[0]= 0x4D601500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x48611500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x39621500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x3E631500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x29641500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x43651500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x44661500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x44671500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x62681500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x4E691500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x556A1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x466B1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x426C1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x356D1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x246E1500;
	dsi_set_cmdq(data_array, 1, 1);
	...
	data_array[0]= 0x4D731500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x48741500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x39751500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x3E761500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x29771500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x43781500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x44791500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x447A1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x627B1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x4E7C1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x557D1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x467E1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x427F1500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x35801500;
	dsi_set_cmdq(data_array, 1, 1);

	data_array[0]= 0x24811500;
	dsi_set_cmdq(data_array, 1, 1);
...
void jd9366_ivo_ips_early_init_lcm(void)
{
