...
{0x3D,1,{0xFF}},	//SET CHGEN_ON,1,{ modify 20140827 
...
//--- power voltage  ----//
{0x55,1,{0x0F}},	//DCDCM=1111,1,{ External pwoer ic
{0x56,1,{0x01}},
{0x57,1,{0x89}},
{0x58,1,{0x0A}},
...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_active_line				= FRAME_HEIGHT;//1320

	params->dsi.horizontal_sync_active				= 40;
	params->dsi.horizontal_backporch				= 40;
	params->dsi.horizontal_frontporch				= 40;
	params->dsi.horizontal_active_pixel			= FRAME_WIDTH;//920
...
LCM_DRIVER jd9366_am080nb03a_wxga_cpt8_lcm_drv = 
{
    .name			= "jd9366_am080nb03a_wxga_cpt8",
