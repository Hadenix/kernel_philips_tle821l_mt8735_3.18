...
static void lcm_get_params(LCM_PARAMS *params)
{
	...
	params->dsi.vertical_backporch					= 12;//16;  //4
	params->dsi.vertical_frontporch					= 16;//9;  //8
	params->dsi.vertical_active_line				= FRAME_HEIGHT; 

	params->dsi.horizontal_sync_active				= 16;//18;  //14
	params->dsi.horizontal_backporch				= 48;//92;  //140
...
static void init_lcm_registers(void)
{
	...
	data_array[2]=0x143d2d28; 
	data_array[3]=0x0c0a0634; 
	data_array[4]=0x15120f17; 
	data_array[5]=0x11071413; 
	data_array[6]=0x04001812;
	data_array[7]=0x3d2c2807;	
	data_array[8]=0x0a063414; 
	data_array[9]=0x120f170c; 
	data_array[10]=0x07131214; 
	data_array[11]=0x00171111; 
...
LCM_DRIVER hx8394d_boe_ips_dis_vdo_lcm_drv = 
{
	.name = "hx8394d_boe_ips_dis_vdo",
