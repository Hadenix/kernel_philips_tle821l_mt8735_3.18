...
#define LOG_1 printk("GC2235,MIPI 2LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .checksum_value = 0x1c1400fc,        //checksum value for Camera Auto Test
    ...
    .pre = {
	  ...
	  .pclk = 21000000,                //record different mode's pclk
        ...
        .grabwindow_width = 1600-32,        //record different mode's width of grabwindow
        .grabwindow_height = 1200-24,        //record different mode's height of grabwindow
    ...
    .cap = {
	  ...
	  .pclk = 21000000,                //record different mode's pclk
        ...
        .startx = 8,//0,
        .starty = 6,//0,
        .grabwindow_width = 1600-32,
        .grabwindow_height = 1200-24,
        .mipi_data_lp2hs_settle_dc = 14,//unit , ns
        .max_framerate = 100,
    },
    .cap1 = {
    ...
    .normal_video = {
	  ...
	  .pclk = 21000000,                //record different mode's pclk
        ...
        .startx = 8,
        .starty = 6,
        .grabwindow_width = 1600-16,
        .grabwindow_height = 1200-12,
        .mipi_data_lp2hs_settle_dc = 14,//unit , ns
        .max_framerate = 100,
    },
    .hs_video = {
...
/////////////////////////////////////////////////////
	...
	write_cmos_sensor(0x17, 0x15);//15//14 //[0]mirror [1]flip
	...
	write_cmos_sensor(0x92, 0x03);
	write_cmos_sensor(0x94, 0x0b); //0x06
	...
	write_cmos_sensor(0x02, 0x51);//mipi drv  11
	write_cmos_sensor(0x03, 0x15);//mipi drv  11
	write_cmos_sensor(0x06, 0x80);
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            if (*sensor_id == GC2235_SENSOR_ID)
            		*sensor_id = GC2235MIPI_SENSOR_ID;
            //ended
