...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = GC2355MIPI_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h
...
//			printk("GC2355 analogic gain 1x , GC2355 add pregain = %d\n",temp);
	...
	else if((ANALOG_GAIN_2<= iReg)&&(iReg < ANALOG_GAIN_3))
	{
			...
			write_cmos_sensor(0xb1, temp>>6);
			write_cmos_sensor(0xb2, (temp<<2)&0xfc);
//			printk("GC2355 analogic gain 1.45x , GC2355 add pregain = %d\n",temp);
	...
	else if((ANALOG_GAIN_3<= iReg)&&(iReg < ANALOG_GAIN_4))
	{
			...
			write_cmos_sensor(0xb1, temp>>6);
			write_cmos_sensor(0xb2, (temp<<2)&0xfc);
//			printk("GC2355 analogic gain 2.02x , GC2355 add pregain = %d\n",temp);
	}
...
//			printk("GC2355 analogic gain 2.8x, temp = %d\n", temp);
	}
