...
void GC0311_Sensor_Init(void)
{
	...
	GC0311_write_cmos_sensor(0x2b, 0x03);   //exp level 0  14.28fps
	GC0311_write_cmos_sensor(0x2c, 0xc0); 
	GC0311_write_cmos_sensor(0x2d, 0x04);   //exp level 1  12.50fps
	GC0311_write_cmos_sensor(0x2e, 0x80); 
	GC0311_write_cmos_sensor(0x2f, 0x04);   //exp level 2  10.00fps
	GC0311_write_cmos_sensor(0x30, 0x80); 
 ...
 /////////////////20120703//////////////////////////
  ...
  /////////////////20120703//////////////////////////						  
	...
	GC0311_write_cmos_sensor(0x44, 0xa2);//a0
...
//	unsigned long long *feature_return_para=(unsigned long long *) pFeaturePara;
    ...
    case SENSOR_FEATURE_SET_YUV_CMD:
        GC0311YUVSensorSetting((FEATURE_ID)*feature_data, *(feature_data+1));
        break;
    case SENSOR_FEATURE_SET_VIDEO_MODE:    //  lanking
	 GC0311YUVSetVideoMode(*feature_data);
	 break;
