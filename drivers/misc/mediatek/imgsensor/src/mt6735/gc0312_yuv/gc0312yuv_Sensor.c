...
void GC0312_Sensor_Init(void)
{
	...
	///////////////////   DNDD  /////////////////////
	///////////////////////////////////////////////// 
	GC0312_write_cmos_sensor(0x82, 0x1f); 
	...
	GC0312_write_cmos_sensor(0x13, 0x30); //38

	GC0312_write_cmos_sensor(0x71, 0x10); 
	GC0312_write_cmos_sensor(0x72, 0x30); 
	...
	GC0312_write_cmos_sensor(0x27, 0x03);   //exp level 0  20fps
	GC0312_write_cmos_sensor(0x28, 0x50); 
...
UINT32 GC0312Open(void)
{
	...
	SENSORDB("GC0312 Sensor Read ID OK \r\n");
	GC0312_Sensor_Init();
	GC0312_Write_More_Registers();
#ifdef DEBUG_SENSOR_GC0312  
		struct file *fp; 
