...
UINT32 BF3920_YUV_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc);
...
//----------------------------------------------------------------------
    ...
    {HM8131MIPI_SENSOR_ID, SENSOR_DRVNAME_HM8131_MIPI_RAW, HM8131_MIPI_RAW_SensorInit}, 
#endif
#if defined(OV8858_MIPI_RAW)
    {OV8858_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW, OV8858_MIPI_RAW_SensorInit}, 
#endif
//---------------------------------------------------------------------- 
   ...
   {GC5004_SENSOR_ID, SENSOR_DRVNAME_GC5004_RAW,GC5004_RAW_SensorInit},
    ...
    {HM5040MIPI_SENSOR_ID, SENSOR_DRVNAME_HM5040MIPI_RAW, HM5040MIPI_RAW_SensorInit}, 
#endif
#if defined(OV5648_MIPI_RAW)
    {OV5648MIPI_SENSOR_ID, SENSOR_DRVNAME_OV5648_MIPI_RAW, OV5648MIPISensorInit},
#endif
...
//----------------------------------------------------------------------
...
#endif
#if defined(GC2355_MIPI_RAW)
   {GC2355MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2355MIPI_RAW,GC2355_MIPI_RAW_SensorInit},
#endif
   ...
   {GC2235MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2235MIPI_RAW,GC2235_MIPI_RAW_SensorInit},
	...
	{GC2755MIPI_SENSOR_ID, SENSOR_DRVNAME_GC2755MIPI_RAW,GC2755_MIPI_RAW_SensorInit},
#endif
#if defined(SP2508_MIPI_RAW)
    {SP2508_SENSOR_ID, SENSOR_DRVNAME_SP2508MIPI_RAW, SP2508_MIPI_RAW_SensorInit}, 
#endif
//----------------------------------------------------------------------
#if defined(GC0310_MIPI_YUV)
...
#endif
#if defined(SIV121DU_YUV)
    {SIV121DU_SENSOR_ID, SENSOR_DRVNAME_SIV121DU_YUV, SIV121DU_YUV_SensorInit}, 
#endif
