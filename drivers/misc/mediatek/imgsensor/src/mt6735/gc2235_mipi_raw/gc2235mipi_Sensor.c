    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
	     	printk("gc2235get_imgsensor_id ID=%x\r\n",*sensor_id);
			*sensor_id += 1;//  GC2355MIPI_SENSOR_ID;
			
			printk("gc2235 get_imgsensor_id sensor_id =%x \n",*sensor_id);

					printk("gc2235 get_imgsensor_idimgsensor_info.sensor_id =%x \n",imgsensor_info.sensor_id);
...
static kal_uint32 open(void)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
			...
			printk("gc2235 get id sensor_id =%x \n",sensor_id);
				printk("gc2235 get id imgsensor_info.sensor_id =%x \n",imgsensor_info.sensor_id);
