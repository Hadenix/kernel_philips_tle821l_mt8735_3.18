...
void GC2155_night_mode(kal_bool enable)
{
		...
		if (GC2155_sensor_cap_state == KAL_FALSE) 
		{
			...
			else 
			{
				...
				{
					GC2155_write_cmos_sensor(0xfe, 0x01);
					GC2155_write_cmos_sensor(0x3c, 0x00);
					GC2155_write_cmos_sensor(0xfe, 0x00);
				}
				else 
				{
...
static void GC2155_Sensor_Init(void)
{
	...
	GC2155_write_cmos_sensor(0xf8 , 0x83);
	...
	GC2155_write_cmos_sensor(0x17 , 0x14);
	...
	GC2155_write_cmos_sensor(0x24 , 0x3f);
	...
	/////////////////////////////////////////////// 
	GC2155_write_cmos_sensor(0xfe , 0x02);
	GC2155_write_cmos_sensor(0xd1 , 0x34);
	GC2155_write_cmos_sensor(0xd2 , 0x34);
	GC2155_write_cmos_sensor(0xd3 , 0x42);
	GC2155_write_cmos_sensor(0xd5 , 0xfa);
	...
	GC2155_write_cmos_sensor(0x06 , 0x5c);
	GC2155_write_cmos_sensor(0x07 , 0x00);
	GC2155_write_cmos_sensor(0x08 , 0xc1);
	GC2155_write_cmos_sensor(0xfe , 0x01);
	GC2155_write_cmos_sensor(0x25 , 0x00);
	GC2155_write_cmos_sensor(0x26 , 0xc7); 
	GC2155_write_cmos_sensor(0x27 , 0x04); 
	GC2155_write_cmos_sensor(0x28 , 0xaa); //13fps 
	GC2155_write_cmos_sensor(0x29 , 0x07); 
	GC2155_write_cmos_sensor(0x2a , 0xc6); //10fps 
	GC2155_write_cmos_sensor(0x2b , 0x09); 
	GC2155_write_cmos_sensor(0x2c , 0x54); //8fps
	GC2155_write_cmos_sensor(0x2d , 0x0c); 
	GC2155_write_cmos_sensor(0x2e , 0x70); //6fps
	GC2155_write_cmos_sensor(0xfe , 0x00);
}
...
static void GC2155_Sensor_SVGA(void)
{
	...
	GC2155_write_cmos_sensor(0xc2 , 0x10);
	//// crop window              
	GC2155_write_cmos_sensor(0xfe , 0x00);
	GC2155_write_cmos_sensor(0x90 , 0x01); 
	GC2155_write_cmos_sensor(0x91 , 0x00);
...
static void GC2155_Sensor_2M(void)
{
	...
	GC2155_write_cmos_sensor(0xc2 , 0x00);
	//// crop window
	GC2155_write_cmos_sensor(0xfe , 0x00);
	GC2155_write_cmos_sensor(0x90 , 0x01);
	GC2155_write_cmos_sensor(0x91 , 0x00);
...
BOOL GC2155_set_param_banding(UINT16 para)
{
	...
	GC2155_write_cmos_sensor(0xfe , 0x00);
		...
		GC2155_write_cmos_sensor(0xfe, 0x00);
		GC2155_write_cmos_sensor(0x05, 0x01);
		GC2155_write_cmos_sensor(0x06, 0x1d);
		GC2155_write_cmos_sensor(0x07, 0x00);
		GC2155_write_cmos_sensor(0x08, 0x19);
		GC2155_write_cmos_sensor(0xfe, 0x01);
		GC2155_write_cmos_sensor(0x25, 0x00);
		GC2155_write_cmos_sensor(0x26, 0xaf); 
		GC2155_write_cmos_sensor(0x27, 0x04);
		GC2155_write_cmos_sensor(0x28, 0x1a); //16fps 
		GC2155_write_cmos_sensor(0x29, 0x06);
		GC2155_write_cmos_sensor(0x2a, 0x27); //13fps 
		GC2155_write_cmos_sensor(0x2b, 0x08);
		GC2155_write_cmos_sensor(0x2c, 0x34); //10fps  
		GC2155_write_cmos_sensor(0x2d, 0x0a);
		GC2155_write_cmos_sensor(0x2e, 0xf0); //7fps 
		GC2155_write_cmos_sensor(0xfe, 0x00); 
            break;
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_NIGHTMODE:
			GC2155_night_mode((BOOL) *feature_data);
		break;
		...
		case SENSOR_FEATURE_SET_YUV_CMD:
			...
			GC2155YUVSensorSetting((FEATURE_ID)*feature_data, *(feature_data+1));
		break;
		case SENSOR_FEATURE_SET_VIDEO_MODE:
		       GC2155YUVSetVideoMode(*feature_data);
		       break; 
		default:
			break;			
	}
