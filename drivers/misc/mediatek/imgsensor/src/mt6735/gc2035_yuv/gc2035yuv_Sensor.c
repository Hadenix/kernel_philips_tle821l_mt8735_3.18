...
///////////CHT809B////////
	...
	GC2035_write_cmos_sensor(0xc1 , 0x3c); //Green_cc for d  40
 ...
 /////// CHT809B///////////////
  ...
  GC2035_write_cmos_sensor(0x4f , 0x01);
	...
	GC2035_write_cmos_sensor(0xd2 , 0x30);//saturation_Cr //38 travis  34
...
//	unsigned long long *feature_return_para=(unsigned long long *) pFeaturePara;
	...
	switch (FeatureId)
	{
		...
		case SENSOR_FEATURE_SET_NIGHTMODE:
			GC2035_night_mode((BOOL) *feature_data);
		break;
		...
		case SENSOR_FEATURE_SET_VIDEO_MODE:
		       GC2035YUVSetVideoMode(*feature_data);
		       break; 
		default:
			break;			
	}
