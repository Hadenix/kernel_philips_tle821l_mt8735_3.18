...
void GC0328_Sensor_Init(void)
{
	...
	GC0328_write_cmos_sensor(0x84 , 0xe2);//e5//20140820
        ...
        MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
    ...
    {
	case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
		printk("MSDK_SCENARIO_ID_CAMERA_PREVIEW\n");
		break;
...
BOOL GC0328_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			...
			GC0328_write_cmos_sensor(0x78, 0x46);
			GC0328_write_cmos_sensor(0x79, 0x46);
		break;
		
		case AWB_MODE_DAYLIGHT: //sunny
			GC0328_awb_enable(KAL_FALSE);
			GC0328_write_cmos_sensor(0x77, 0x80); 
			GC0328_write_cmos_sensor(0x78, 0x48);
			GC0328_write_cmos_sensor(0x79, 0x68);			
		break;
		...
		case AWB_MODE_INCANDESCENT: //office
			...
			GC0328_write_cmos_sensor(0x78, 0x40);
			GC0328_write_cmos_sensor(0x79, 0x8c);
		break;
		...
		case AWB_MODE_FLUORESCENT:
			...
			GC0328_write_cmos_sensor(0x77, 0x48);
			GC0328_write_cmos_sensor(0x78, 0x40);
			GC0328_write_cmos_sensor(0x79, 0x66);
		break;
