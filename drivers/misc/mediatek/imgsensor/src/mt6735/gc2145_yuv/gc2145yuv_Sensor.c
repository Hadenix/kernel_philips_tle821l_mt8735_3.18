...
//static kal_uint16 GC2145_extra_exposure_lines = 0;
...
static void GC2145_Sensor_Init(void)
{
	...
	GC2145_write_cmos_sensor(0x13 , 0x6d);
	...
	GC2145_write_cmos_sensor(0x97 , 0x87);
	...
	/////////////////////////////////////////////// 
	GC2145_write_cmos_sensor(0xfe , 0x02);
	GC2145_write_cmos_sensor(0xd1 , 0x34);
	GC2145_write_cmos_sensor(0xd2 , 0x34);
	GC2145_write_cmos_sensor(0xd3 , 0x48);
	GC2145_write_cmos_sensor(0xd5 , 0xfa);
	...
	GC2145_write_cmos_sensor(0x2a , 0xe2); //14fps 
	GC2145_write_cmos_sensor(0x2b , 0x06); 
	GC2145_write_cmos_sensor(0x2c , 0xd6); //12fps
