 ...
 ****************************************************************************/
  ...
  #ifdef S5K4ECGX_MAIN_2_USE_HW_I2C
    #define S5K4ECGX_SUPPORT_N3D
  #endif
#endif
...
static DEFINE_SPINLOCK(s5k4ecgx_rw_lock);


static kal_uint32  S5K4ECGX_sensor_pclk = 390 * 1000000;
...
//
kal_uint8 S5K4ECGX_sensor_write_I2C_address = S5K4ECGX_WRITE_ID;
kal_uint8 S5K4ECGX_sensor_read_I2C_address = S5K4ECGX_READ_ID;
kal_uint8 S5K4ECGX_sensor_socket = DUAL_CAMERA_NONE_SENSOR;
struct S5K4ECGX_sensor_struct S5K4ECGX_Driver;
unsigned int S5K4ECGX_Preview_enabled = 0;
unsigned int s5k4ec_cap_enable = 0;

/*
unsigned short S5K4ECGX_DEFAULT_AE_TABLE[32] =
{
...
static kal_uint16 S5K4ECGX_read_cmos_sensor(kal_uint32 addr)
{
   kal_uint16 get_byte=0;
   char puSendCmd[2] = {(char)(addr >> 8) , (char)(addr & 0xFF) };
   iReadRegI2C(puSendCmd , 2, (u8*)&get_byte, 2, S5K4ECGX_sensor_write_I2C_address);
   return ((get_byte<<8)&0xff00)|((get_byte>>8)&0x00ff);
}
...
{
   char puSendCmd[4] = {(char)(addr >> 8) , (char)(addr & 0xFF) ,(char)(para >> 8),(char)(para & 0xFF)};
   iWriteRegI2C(puSendCmd , 4,S5K4ECGX_sensor_write_I2C_address);
   SENSORDB("[Write]:id=0x%x, addr=0x%x, para=0x%x\r\n", S5K4ECGX_sensor_write_I2C_address, addr, para);
}
...
//dereffff();
   ...
   while(IDX < len)
   {
       ...
       {
           BLOCK_I2C_DATA_WRITE(puSendCmd , tosend, S5K4ECGX_sensor_write_I2C_address);
           tosend = 0;
       }
   }
   return 0;
...
UINT32 S5K4ECGX_SetTestPatternMode(kal_bool bEnable)
{
    //SENSORDB("[S5K4ECGX_SetTestPatternMode] Fail: Not Support. Test pattern enable:%d\n", bEnable);
    //output color bar
...
**    AF Control Start
***********************************************************/
void S5K4ECGX_set_scene_mode(UINT16 para);
BOOL S5K4ECGX_set_param_wb(UINT16 para);



static void
S5K4ECGX_AE_Lock(void)
{
...
S5K4ECGX_AWB_UnLock(void)
{
    ...
    {
       S5K4ECGX_set_scene_mode(S5K4ECGX_Driver.sceneMode);
    }
    else
    {
        if (!((AWB_MODE_OFF == S5K4ECYXCurrentStatus.iWB) || 
            (AWB_MODE_AUTO == S5K4ECYXCurrentStatus.iWB)))
        {
            S5K4ECGX_set_param_wb(S5K4ECYXCurrentStatus.iWB);
        }
    }
    if (!((AWB_MODE_OFF == S5K4ECYXCurrentStatus.iWB) ||
        (AWB_MODE_AUTO == S5K4ECYXCurrentStatus.iWB)))
...
static void 
S5K4ECGX_AE_ExpCurveGain_Config(unsigned int SceneMode)
{
...
void S5K4ECGX_AE_Rollback_Weight_Table(void)
{
    ...
    pae_table = (unsigned short *) (&S5K4ECGX_DEFAULT_AE_TABLE[0]);
...
static void
S5K4ECGX_AE_Dump_WeightTbl(void)
{
    //debug only, readback
    unsigned int val[32];
...
unsigned short
S5K4ECGX_AE_Get_WeightVal(unsigned int x, unsigned int y)
{
...
static void
S5K4ECGX_AE_Set_Window2HW(void)
{
    ...
    exposureTime = S5K4ECGX_GetExposureTime();
    Sleep(exposureTime);
    ...
    //S5K4ECGX_AE_Dump_WeightTbl();
    return;
}



#define S5K4ECGX_AE_MAX_WEIGHT_VAL 0xF
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_AE_Set_Window(
...
/*    unsigned int x0, y0, x1, y1, width, height, i, j, xx, yy;
    ...
    if ((x0 == x1) && (y0 == y1))
    {
        ...
        memcpy((unsigned char*)&ae_table[0][0], (unsigned char*)&S5K4ECGX_DEFAULT_AE_TABLE[0], 64);
    ...
    if (0 == aeStateOnOriginalSet)
    {
        ...
        ae_table[y1][x1] = S5K4ECGX_AE_MAX_WEIGHT_VAL;
   }
    ...
    S5K4ECGX_AE_Set_Window2HW();
    S5K4ECGX_AE_Dump_WeightTbl();
    //SENSORDB("S5K4ECGX ~~~~S5K4ECGX_AE_Set_Window: (%d,%d)~(%d,%d)\n",x0, y0, x1, y1);
	*/
    return S5K4ECGX_AAA_AF_STATUS_OK;
}
...
static void
S5K4ECGX_AF_Get_Max_Num_Focus_Areas(unsigned int *pFeatureReturnPara32)
{
...
static void
S5K4ECGX_AE_Get_Max_Num_Metering_Areas(unsigned int *pFeatureReturnPara32)
{
    *pFeatureReturnPara32 = 1;
    //SENSORDB("S5K4ECGX_AE_Get_Max_Num_Metering_Areas *pFeatureReturnPara32 = %d\n",  *pFeatureReturnPara32);
}

static void
S5K4ECGX_AF_Get_Inf(unsigned int *pFeatureReturnPara32)
{
    *pFeatureReturnPara32 = 0;
}

static void
S5K4ECGX_AF_Get_Macro(unsigned int *pFeatureReturnPara32)
{
...
static void
S5K4ECGX_AF_rollbackWinSet(void)
{
    S5K4ECGX_AF_WIN_T  *AfWindows;
...
S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_AF_Set_Window2HW(void)
{
...
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_AF_Set_Window(
    unsigned int zone_addr,
    unsigned int prevW,
    unsigned int prevH)
{
		unsigned long t_zone_addr = zone_addr;
    unsigned int x0, y0, x1, y1, FD_XS, FD_YS;
    unsigned int* ptr = (unsigned int*)t_zone_addr;
    unsigned int srcW_maxW = S5K4ECGX_AF_CALLER_WINDOW_WIDTH;
    unsigned int srcW_maxH = S5K4ECGX_AF_CALLER_WINDOW_HEIGHT;
    ...
    frameTime = S5K4ECGX_GetExposureTime();
    //frameTime = 30;
    ...
    if (S5K4ECGX_Driver.afStateOnOriginalSet)
    {
        ...
        S5K4ECGX_AF_rollbackWinSet();
    }
    else
    {
        SENSORDB("[4EC] AF window Update New Window.......\n");
        S5K4ECGX_AF_Set_Window2HW();
    }
...
S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_AF_Stop(void)
{

#if 0
#if defined(S5K4ECGX_AF_Enable)
    ...
    SENSORDB("S5K4ECGX ~~~~S5K4ECGX_AF_Stop---\n");
#endif
#endif
...
/*
static void
S5K4ECGX_AF_ShowLensPosition(void)
{
...
S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_AF_Start(S5K4ECGX_AF_MODE_ENUM mode)
{
    unsigned int af_status;
    unsigned int frameTime;
...
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_AF_Move_to(unsigned int a_u2MovePosition)//??how many bits for ov3640??
{
    return S5K4ECGX_AAA_AF_STATUS_OK;
}
...
static S5K4ECGX_AAA_STATUS_ENUM
S5K4ECGX_AF_Get_Status(unsigned int *pFeatureReturnPara32)
{
...
*
*************************************************************************/
static kal_uint16 S5K4ECGX_ReadShutter(void)
{
...
void S5K4ECGX_SetShutter(kal_uint32 iShutter)
{
#if 0
...
* LOCAL AFFECTED
*************************************************************************/
static kal_uint32 S5K4ECGX_ReadGain(void)
{
#if 0
    kal_uint32 Reg ;
    S5K4ECGX_write_cmos_sensor(0x002C, 0x7000);
...
static void S5K4ECGX_SetGain(kal_uint32 iGain)
{
#if 0
    kal_uint32 Reg ;
...
void S5K4ECGX_get_exposure_gain()
{
...
void S5K4ECGX_GetAEFlashlightInfo(UINT32 infoAddr)
{
//    SENSOR_FLASHLIGHT_AE_INFO_STRUCT* pAeInfo = (MUINT64)((SENSOR_FLASHLIGHT_AE_INFO_STRUCT*) infoAddr);
#if 0
    pAeInfo->Exposuretime = S5K4ECGX_ReadShutter();
    pAeInfo->Gain = S5K4ECGX_ReadGain();
    pAeInfo->u4Fno = 28;
...
static void S5K4ECGX_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    unsigned int NormBr;
...
#define CLK0_SYS_OP_RATE   0x4074
#define CLK0_MIN           0x59D8
#define CLK0_MAX           0x59D8

#define CLK1_SYS_OP_RATE   0x4074 //0x4F1A; //for 15fps capture
#define CLK1_MIN           0x59D8
#define CLK1_MAX           0x59D8
#define CAP_CLK_IDX        1
...
static void S5K4ECGX_Init_Setting(void)
{
    ...
    S5K4ECGX_sensor_pclk = CLK0_MAX * 4000 * 2; //(reg_val * 4k * 2)
    S5K4ECGX_write_cmos_sensor(0xFCFC, 0xD000);
    ...
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x0155); //cregs_d0_d4_cd10 //D4[9:8], D3[7:6], D2[5:4], D1[3:2], D0[1:0]
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x0155); //cregs_d5_d9_cd10 //D9[9:8], D8[7:6], D7[5:4], D6[3:2], D5[1:0]
    S5K4ECGX_write_cmos_sensor(0x002A, 0x1088);
    S5K4ECGX_write_cmos_sensor(0x0F12, 0x05d5); //cregs_clks_output_cd10 //SDA[11:10], SCL[9:8], PCLK[7:6], VSYNC[3:2], HSYNC[1:0]
...
/*             0x0028, 0x7000,
    ...
    //    {
        // Refer Mon_AWB_RotGain
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x5000); //TVAR_ash_GASAlpha_0__0_ R  // 2300K
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x5000); //20130513, 4000, //TVAR_ash_GASAlpha_1__0_ R  // 2750K
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x5000); //TVAR_ash_GASAlpha_6__0_ R  // 7500K
    ...
    //==================================================================================
        ...
        // Indoor Grid Offset
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_0__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_0__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_0__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_0__3_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_0__4_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_0__5_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_1__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_1__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_1__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_1__3_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_1__4_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_1__5_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_2__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_2__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_2__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_2__3_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_2__4_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_2__5_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_0__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_0__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_0__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_0__3_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_0__4_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_0__5_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_1__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_1__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_1__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_1__3_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_1__4_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_1__5_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_2__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_2__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_2__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_2__3_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_2__4_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_2__5_

        // Outdoor Grid Offset
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_0__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_0__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_0__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_0__3_
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_1__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_1__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_1__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_1__3_
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_2__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_2__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_2__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_R_Out_2__3_
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_0__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_0__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_0__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_0__3_
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_1__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_1__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_1__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_1__3_
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_2__0_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_2__1_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_2__2_
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //awbb_GridCorr_B_Out_2__3_
  ...
  //  {
   ...
   //     {
    ...
    //==================================================================================
        //AE Target
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0038);   //TVAR_ae_BrAve  //0x38
   ...
   // }
    ...
    // 13.AE Weight (Normal)
    //==================================================================================
   // S5K4ECGX_AE_Rollback_Weight_Table();
...
//#if 1   
    ...
    //==================================================================================
			...
			S5K4ECGX_write_cmos_sensor(0x0F12, 0x0004);//saRR_usDualGammaLutRGBIndoor[0][1]
			S5K4ECGX_write_cmos_sensor(0x0F12, 0x000B);//saRR_usDualGammaLutRGBIndoor[0][2]
			S5K4ECGX_write_cmos_sensor(0x0F12, 0x001B);//saRR_usDualGammaLutRGBIndoor[0][3]
			S5K4ECGX_write_cmos_sensor(0x0F12, 0x0046);//saRR_usDualGammaLutRGBIndoor[0][4]
			S5K4ECGX_write_cmos_sensor(0x0F12, 0x00AE);//saRR_usDualGammaLutRGBIndoor[0][5]
			S5K4ECGX_write_cmos_sensor(0x0F12, 0x011E);//saRR_usDualGammaLutRGBIndoor[0][6]
			S5K4ECGX_write_cmos_sensor(0x0F12, 0x0154);//saRR_usDualGammaLutRGBIndoor[0][7]
			S5K4ECGX_write_cmos_sensor(0x0F12, 0x0184);//saRR_usDualGammaLutRGBIndoor[0][8]
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);//on/offAFITbyNBoption
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0x001c);//7000098E//AFIT16_CONTRAST
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0x001d);//70000A44//AFIT16_CONTRAST
S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);//70000A46//AFIT16_SATURATION 0x0015
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0x001d);//70000AFA//AFIT16_CONTRAST
S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);//70000AFC//AFIT16_SATURATION  0x0015
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0x001d);//70000BB0//AFIT16_CONTRAST
S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);//70000BB2//AFIT16_SATURATION 0x0015
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0x001d);//70000C66//AFIT16_CONTRAST
S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);//70000C68//AFIT16_SATURATION  0x0015
...
S5K4ECGX_write_cmos_sensor(0x0F12, 0x0001);//70000D18AFITB_bnr_nClustLevel_C[0]bWideWide[1]
...
//#endif 
    ...
    //==================================================================================
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0010);      //0x5DC0
    ...
    //For MCLK=24MHz, PCLK=5DC0
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0002);   //0x212:REG_TC_IPRM_UseNPviClocks
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);   //0x214:REG_TC_IPRM_UseNMipiClocks
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000);   //0x216:REG_TC_IPRM_NumberOfMipiLanes

             S5K4ECGX_write_cmos_sensor(0x002A, 0x021A);
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_SYS_OP_RATE);  //0x4F1A//0x3A98//0x32c8);
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_MAX); //REG_TC_IPRM_MinOutRate4KHz_0 PCLK Min : 81Mhz
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_MIN); //REG_TC_IPRM_MaxOutRate4KHz_0 PCLK Max : 81Mhz

             S5K4ECGX_write_cmos_sensor(0x0F12, CLK1_SYS_OP_RATE);  //0x32c8//0x4F1A;
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK1_MIN); //REG_TC_IPRM_MinOutRate4KHz_1 PCLK Min : 81Mhz
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK1_MAX); //REG_TC_IPRM_MaxOutRate4KHz_1 PCLK Max : 81Mhz
    ...
    //91MHz, 1280x960, Dynamic mode 30~7.5fps
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_MAX);  //REG_0TC_PCFG_usMaxOut4KHzRate PCLK Min : xxMhz
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_MIN);  //REG_0TC_PCFG_usMinOut4KHzRate PCLK Max : xxMhz
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0535); //REG_0TC_PCFG_usMaxFrTimeMsecMult10 //0x0535
  ...
  //      {
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 1280);   //REG_1TC_PCFG_usWidth
             S5K4ECGX_write_cmos_sensor(0x0F12, 960);    //REG_1TC_PCFG_usHeight
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0005);   //REG_1TC_PCFG_Format 5 YUV 7 Raw 9 JPG
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_MAX);  //REG_1TC_PCFG_usMaxOut4KHzRate PCLK Min : xxMhz
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_MIN);  //REG_1TC_PCFG_usMinOut4KHzRate PCLK Max : xxMhz
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0002);   //REG_1TC_PCFG_usFrTimeType
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0001);   //REG_1TC_PCFG_FrRateQualityType
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x014d);   //REG_1TC_PCFG_usMaxFrTimeMsecMult10
  ...
  //  }
   ...
   //     {
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 2560);   //REG_2TC_PCFG_usWidth
             S5K4ECGX_write_cmos_sensor(0x0F12, 1920);   //REG_2TC_PCFG_usHeight
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0005);   //REG_2TC_PCFG_Format 5 YUV 7 Raw 9 JPG
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_MAX);  //REG_2TC_PCFG_usMaxOut4KHzRate PCLK Min : xxMhz
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK0_MIN);  //REG_2TC_PCFG_usMinOut4KHzRate PCLK Max : xxMhz
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0002);   //REG_2TC_PCFG_FrRateQualityType
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0535);   //REG_2TC_PCFG_usMaxFrTimeMsecMult10
  ...
  //  {
   ...
   //     {
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK1_MAX);  //REG_0TC_CCFG_usMaxOut4KHzRate PCLK Min : xxMhz
             S5K4ECGX_write_cmos_sensor(0x0F12, CLK1_MIN);  //REG_0TC_CCFG_usMinOut4KHzRate PCLK Max : xxMhz
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, CAP_CLK_IDX);   //REG_0TC_CCFG_uClockInd
    ...
    //Select preview 0
             ...
             S5K4ECGX_write_cmos_sensor(0x0F12, 0x0000); //REG_TC_GP_ActivePrevConfig
...
*
*************************************************************************/
static void S5K4ECGX_GetEvAwbRef(PSENSOR_AE_AWB_REF_STRUCT Ref)  //???
{
...
*
*************************************************************************/
static void S5K4ECGX_GetCurAeAwbInfo(PSENSOR_AE_AWB_CUR_STRUCT Info)
{
    //Info->SensorAECur.AeCurShutter = S5K4ECGX_ReadShutter();
    //Info->SensorAECur.AeCurGain = S5K4ECGX_ReadGain(); /* 128 base */
    //S5K4ECGX_write_cmos_sensor(0x0028, 0x7000);
...
//sgs add 20140319
int isS5k4ecgxSensor = 0;
//sgs add end;

UINT32 S5K4ECGX_GetSensorID(UINT32 *sensorID)
{
   int  retry = 3;
...
UINT32 S5K4ECGX_Open(void)
{
    kal_uint32 sensor_id=0;

    SENSORDB("[Enter]:S5K4ECGX_Open:\r\n");
    S5K4ECGX_GetSensorID(&sensor_id);
...

{
   ...
   ////////////////////////////////////////////////////////////////////
        ...
        S5K4ECGX_write_cmos_sensor(0x0F12, 0x5DC0);
        S5K4ECGX_write_cmos_sensor(0x002A, 0x0212);
        ...
        S5K4ECGX_write_cmos_sensor(0x002A, 0x021A);
        S5K4ECGX_write_cmos_sensor(0x0F12, 0x4074);  //0x4F1A//0x3A98//0x32c8);
        S5K4ECGX_write_cmos_sensor(0x0F12, 0x59D8); //REG_TC_IPRM_MinOutRate4KHz_0 PCLK Min : 81Mhz
        S5K4ECGX_write_cmos_sensor(0x0F12, 0x59D8); //REG_TC_IPRM_MaxOutRate4KHz_0 PCLK Max : 81Mhz

        S5K4ECGX_write_cmos_sensor(0x0F12, 0x4074);  //0x32c8//0x4F1A;
        S5K4ECGX_write_cmos_sensor(0x0F12, 0x59D8); //REG_TC_IPRM_MinOutRate4KHz_1 PCLK Min : 81Mhz
        S5K4ECGX_write_cmos_sensor(0x0F12, 0x59D8); //REG_TC_IPRM_MaxOutRate4KHz_1 PCLK Max : 81Mhz
...
void S5K4ECGX_GetAutoISOValue(void)
{
...
void S5K4ECGX_GetActiveConfigNum(unsigned int *pActiveConfigNum)
{
    spin_lock(&s5k4ecgx_drv_lock);
...
void S5K4ECGX_SetFrameRate(MSDK_SCENARIO_ID_ENUM scen, UINT16 u2FrameRate)
{
...
UINT32 S5K4ECGX_StopPreview(void)
{
...
static void S5K4ECGX_Capture_Mode_Setting(kal_uint8 capture_mode)
{
    ...
    S5K4ECGX_AF_CancelFocus(); //Lock AF //Debug

    S5K4ECGX_StopPreview();
...
static void S5K4ECGX_HVMirror(kal_uint8 image_mirror)
{
    ...
    *********************************************************/
    ...
    //if(S5K4ECYXCurrentStatus.iMirror == image_mirror)
    //    return;
    ...
    //spin_lock(&s5k4ecgx_drv_lock);
    //S5K4ECYXCurrentStatus.iMirror = image_mirror;
    //spin_unlock(&s5k4ecgx_drv_lock);
}
...
void S5K4ECGX_SceneOffMode()
{
   ...
   //Frame Rate!!
   S5K4ECGX_write_cmos_sensor(0x002A, 0x02C2);
   S5K4ECGX_write_cmos_sensor(0x0F12, 0x0535);  //7.5FPS// REG_0TC_PCFG_usMaxFrTimeMsecMult10 //029Ah:15fps 0x0535
...
*
*************************************************************************/
static UINT32 S5K4ECGX_Preview(
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    {
       S5K4ECGX_Preview_Mode_Setting(S5K4EC_PREVIEW_MODE);
           ...
           (height != S5K4ECGX_IMAGE_SENSOR_PV_HEIGHT_DRV))
       {
           ...
           S5K4ECGX_AE_Set_Window(S5K4ECGX_Driver.apAEWindows,
    ...
    {
       S5K4ECGX_Preview_Mode_Setting(S5K4EC_VIDEO_MODE);
    }
...
static UINT32 S5K4ECGX_Preview_ZSD(
    MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    unsigned int width, height;
    ...
    S5K4ECGX_Preview_Mode_Setting(S5K4EC_PREVIEW_FULLSIZE_MODE); ////MODE0=10-30FPS
    ...
    MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
    ...
    //shutter = S5K4ECGX_ReadShutter();
    //gain = S5K4ECGX_ReadGain();
...
UINT32 S5K4ECGX_GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
...
UINT32 S5K4ECGX_GetInfo(MSDK_SCENARIO_ID_ENUM ScenarioId,
    ...
    MSDK_SENSOR_CONFIG_STRUCT *pSensorConfigData)
{
   ...
   switch (ScenarioId)
   {
      case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
      case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
         S5K4ECGX_Preview(pImageWindow, pSensorConfigData);
         break;
      case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
         S5K4ECGX_Capture(pImageWindow, pSensorConfigData);
         break;
      case MSDK_SCENARIO_ID_CAMERA_ZSD:
     S5K4ECGX_Preview_ZSD(pImageWindow, pSensorConfigData);
         break;
      default:
         break;
   }

   //SENSORDB("[Exit]:S5K4ECGX_Control  func\n");
   return ERROR_NONE;
} /* S5K4ECGXControl() */
...
//    spin_lock(&s5k4ecgx_drv_lock);
//    S5K4ECYXCurrentStatus.iWB = para;
//    spin_unlock(&s5k4ecgx_drv_lock);
...
*
*************************************************************************/
#define S5K4ECGX_MAX_AXD_GAIN (12 << 8) //max gain = 12
#define S5K4ECGX_MAX_EXPOSURE_TIME ( 133 * 100) // max exposure time = 133ms

//This function is optimized version for setting EV value in order to meet
BOOL S5K4ECGX_set_param_exposure_for_HDR(UINT16 para)
{
  ...
  switch (para)
  {
    ...
    totalGain = (totalGain > S5K4ECGX_MAX_AXD_GAIN) ? S5K4ECGX_MAX_AXD_GAIN : totalGain;
    exposureTime = (exposureTime > S5K4ECGX_MAX_EXPOSURE_TIME) ? S5K4ECGX_MAX_EXPOSURE_TIME : exposureTime;
...
BOOL S5K4ECGX_set_param_exposure(UINT16 para)
{
   ...
   {
       spin_unlock(&s5k4ecgx_drv_lock);
       S5K4ECGX_set_param_exposure_for_HDR(para);
       return TRUE;
   }
   spin_unlock(&s5k4ecgx_drv_lock);
...
void S5K4ECGX_get_AEAWB_lock(UINT32 *pAElockRet32,UINT32 *pAWBlockRet32)
{
    *pAElockRet32 = 1;
    *pAWBlockRet32 = 1;
...
void S5K4ECGX_set_brightness(UINT16 para)
{
...
void S5K4ECGX_set_contrast(UINT16 para)
{
...
void S5K4ECGX_set_iso(UINT16 para)
{
...
void S5K4ECGX_set_saturation(UINT16 para)
{
    ...
    S5K4ECGX_write_cmos_sensor(0x0F12 ,0x0020);  //REG_TC_UserSaturation
/*    switch (para)
    {
        case ISP_SAT_HIGH:
...
void S5K4ECGX_set_scene_mode(UINT16 para)
{
    ...
    S5K4ECGX_GetActiveConfigNum(&activeConfigNum);
    spin_lock(&s5k4ecgx_drv_lock);
    ...
    {
        S5K4ECGX_AE_ExpCurveGain_Config(para);
    }
    ...
    {
        S5K4ECGX_SetFrameRate(S5K4ECGXCurrentScenarioId, 30);
    }
    else
    {
        ...
        //S5K4ECGX_SetFrameRate(S5K4ECGXCurrentScenarioId, 15);
    }
    ...
    switch (para)
    {
        ...
        default:
            ...
            S5K4ECGX_SceneOffMode(); ////MODE0=10-30FPS
            break;
    }
    return;
}
...
UINT32 S5K4ECGX_SensorSetting(FEATURE_ID iCmd, UINT32 iPara)
{
    ...
    switch (iCmd)
    {
        ...
        case FID_ISP_CONTRAST:
            ...
            S5K4ECGX_set_contrast(iPara);
            break;
        case FID_ISP_BRIGHT:
            SENSORDB("[4EC]FID_ISP_BRIGHT:%d\n",iPara);
            S5K4ECGX_set_brightness(iPara);
            break;
        case FID_ISP_SAT:
            SENSORDB("[4EC]FID_ISP_SAT:%d\n",iPara);
            S5K4ECGX_set_saturation(iPara);
            break;
        case FID_AE_ISO:
            SENSORDB("[4EC]FID_AE_ISO:%d\n",iPara);
            S5K4ECGX_set_iso(iPara);
            break;
        default:
    ...
    return TRUE;
}   /* S5K4ECGXSensorSetting */



void S5K4ECGX_SetVideoMode(UINT16 u2FrameRate)
{
    ...
    S5K4ECGX_SetFrameRate(MSDK_SCENARIO_ID_VIDEO_PREVIEW, u2FrameRate);
    return;
}


void S5K4ECGX_GetExifInfo(UINT32 exifAddr)
{
		unsigned long t_exifAddr = exifAddr;
    SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)t_exifAddr;
...
void S5K4ECGX_GetDelayInfo(UINT32 delayAddr)
{
		unsigned long t_delayAddr = delayAddr;
    SENSOR_DELAY_INFO_STRUCT* pDelayInfo = (SENSOR_DELAY_INFO_STRUCT*)t_delayAddr;
...
UINT32 S5K4ECGX_SetMaxFramerateByScenario(
...
#if 0
    SENSORDB("S5K4ECGX_SetMaxFramerateByScenario: scenarioId = %d, frame rate = %d\n",scenarioId,frameRate);
    switch (scenarioId)
    {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
             pclk = S5K4ECGX_sensor_pclk;
...
UINT32 S5K4ECGX_GetDefaultFramerateByScenario(
...
void S5K4ECGX_3ACtrl(ACDK_SENSOR_3A_LOCK_ENUM action)
{
   switch (action)
   {
...
UINT32 S5K4ECGX_FeatureControl(MSDK_SENSOR_FEATURE_ENUM FeatureId,
               UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	unsigned long long *pFeatureData64=(unsigned long long *) pFeaturePara;
  unsigned long long *pFeatureReturnPara64=(unsigned long long *) pFeaturePara;
    ...
    //SENSORDB("S5K4ECGX_FeatureControl+++ ID=%d\n", FeatureId);
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PIXEL_CLOCK_FREQ:
             ...
             *pFeatureReturnPara32 = S5K4ECGX_sensor_pclk;
             *pFeatureParaLen=4;
             break;

        case SENSOR_FEATURE_SET_NIGHTMODE:
             SENSORDB("[4EC] F_SET_NIGHTMODE\n");
             //S5K4ECGX_NightMode((BOOL) *pFeatureData16);
             //PhaseOut this ID
             break;
        ...
        case SENSOR_FEATURE_SET_ESHUTTER:
             ...
             //S5K4ECGX_SetShutter(*pFeatureData16);
             break;

        case SENSOR_FEATURE_SET_GAIN:
             SENSORDB("[4EC] F_SET_GAIN: Not Support\n");
             //S5K4ECGX_SetGain(*pFeatureData16);
             break;

        case SENSOR_FEATURE_GET_AE_FLASHLIGHT_INFO:
             SENSORDB("[4EC] F_GET_AE_FLASHLIGHT_INFO: Not Support\n");
             //S5K4ECGX_GetAEFlashlightInfo(*pFeatureData32);
             break;

        case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
             S5K4ECGX_FlashTriggerCheck(pFeatureData32);
        ...
        case SENSOR_FEATURE_SET_ISP_MASTER_CLOCK_FREQ:
             ...
             //spin_lock(&s5k4ecgx_drv_lock);
             //S5K4ECGX_isp_master_clock = *pFeatureData32;
             //spin_unlock(&s5k4ecgx_drv_lock);
             break;
        ...
        case SENSOR_FEATURE_SET_YUV_CMD:
             ...
             S5K4ECGX_SensorSetting((FEATURE_ID)*pFeatureData64, *(pFeatureData64+1));
             break;

        case SENSOR_FEATURE_SET_YUV_3A_CMD:
             SENSORDB("[4EC] SENSOR_FEATURE_SET_YUV_3A_CMD ID:%d\n", *pFeatureData32);
             S5K4ECGX_3ACtrl((ACDK_SENSOR_3A_LOCK_ENUM)*pFeatureData32);
             break;

        case SENSOR_FEATURE_SET_VIDEO_MODE:
             SENSORDB("[4EC] F_SET_VIDEO_MODE\n");
             S5K4ECGX_SetVideoMode(*pFeatureData64);
             break;

        case SENSOR_FEATURE_CHECK_SENSOR_ID:
             SENSORDB("[4EC] F_CHECK_SENSOR_ID\n");
             S5K4ECGX_GetSensorID(pFeatureReturnPara32);
             break;

        case SENSOR_FEATURE_GET_EV_AWB_REF:
             SENSORDB("[4EC] F_GET_EV_AWB_REF\n");
             S5K4ECGX_GetEvAwbRef(*pFeatureData64);
             break;

        case SENSOR_FEATURE_GET_SHUTTER_GAIN_AWB_GAIN:
             SENSORDB("[4EC] F_GET_SHUTTER_GAIN_AWB_GAIN\n");
             S5K4ECGX_GetCurAeAwbInfo(*pFeatureData64);
             break;

  #ifdef INTERFACE
        case SENSOR_FEATURE_GET_EXIF_INFO:
             //SENSORDB("[4EC] F_GET_EXIF_INFO\n");
             S5K4ECGX_GetExifInfo(*pFeatureData64);
             break;
  #endif

        case SENSOR_FEATURE_GET_DELAY_INFO:
             SENSORDB("[4EC] F_GET_DELAY_INFO\n");
             S5K4ECGX_GetDelayInfo(*pFeatureData64);
             break;

        case SENSOR_FEATURE_SET_SLAVE_I2C_ID:
             //SENSORDB("[4EC] F_SET_SLAVE_I2C_ID:[%d]\n",*pFeatureData32);
             S5K4ECGX_sensor_socket = *pFeatureData32;
             break;

        case SENSOR_FEATURE_SET_TEST_PATTERN:
             SENSORDB("[4EC] F_SET_TEST_PATTERN\n");
             S5K4ECGX_SetTestPatternMode((BOOL)*pFeatureData64);
             break;

        case SENSOR_FEATURE_SET_MAX_FRAME_RATE_BY_SCENARIO:
             SENSORDB("[4EC] F_SET_MAX_FRAME_RATE_BY_SCENARIO: FAIL: NOT Support\n");
             S5K4ECGX_SetMaxFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData64, *(pFeatureData64+1));
             break;

        case SENSOR_FEATURE_GET_DEFAULT_FRAME_RATE_BY_SCENARIO:
             SENSORDB("[4EC] F_GET_DEFAULT_FRAME_RATE_BY_SCENARIO\n");
             S5K4ECGX_GetDefaultFramerateByScenario((MSDK_SCENARIO_ID_ENUM)*pFeatureData64, (MUINT32 *)(uintptr_t)(*(pFeatureData64+1)));
             break;
        ...
        case SENSOR_FEATURE_MOVE_FOCUS_LENS:
             ...
             S5K4ECGX_AF_Move_to(pFeatureReturnPara32); // not implement yet.
             break;

        case SENSOR_FEATURE_GET_AF_STATUS:
            S5K4ECGX_AF_Get_Status(pFeatureReturnPara32);
        ...
        case SENSOR_FEATURE_SINGLE_FOCUS_MODE:
             ...
             S5K4ECGX_AF_Start(S5K4ECGX_AF_MODE_SINGLE);
             break;

        case SENSOR_FEATURE_CONSTANT_AF:
             SENSORDB("[4EC] F_CONSTANT_AF\n");
             S5K4ECGX_AF_Start(S5K4ECGX_AF_MODE_CONTINUOUS);
             break;

        case SENSOR_FEATURE_CANCEL_AF:
             SENSORDB("[4EC] F_CANCEL_AF\n");
             S5K4ECGX_AF_CancelFocus();
             break;

        case SENSOR_FEATURE_GET_AF_INF:
             SENSORDB("[4EC] F_GET_AF_INF\n");
             S5K4ECGX_AF_Get_Inf(pFeatureReturnPara32);
             *pFeatureParaLen=4;
             break;

        case SENSOR_FEATURE_GET_AF_MACRO:
             S5K4ECGX_AF_Get_Macro(pFeatureReturnPara32);
             SENSORDB("[4EC] F_GET_AF_MACRO=%d\n", *pFeatureReturnPara32);
             *pFeatureParaLen=4;
             break;

        case SENSOR_FEATURE_GET_AF_MAX_NUM_FOCUS_AREAS:
             S5K4ECGX_AF_Get_Max_Num_Focus_Areas(pFeatureReturnPara32);
             SENSORDB("[4EC] F_GET_AF_MAX_NUM_FOCUS_AREAS=%d\n", *pFeatureReturnPara32);
             *pFeatureParaLen=4;
             break;

        case SENSOR_FEATURE_GET_AE_MAX_NUM_METERING_AREAS:
             S5K4ECGX_AE_Get_Max_Num_Metering_Areas(pFeatureReturnPara32);
             SENSORDB("[4EC] F_GET_AE_MAX_NUM_METERING_AREAS=%d\n", *pFeatureReturnPara32);
             *pFeatureParaLen=4;
             break;
        case SENSOR_FEATURE_SET_AF_WINDOW:
             SENSORDB("[4EC] F_SET_AF_WINDOW\n");
             S5K4ECGX_AF_Set_Window(*pFeatureReturnPara32, S5K4ECGX_Driver.Preview_Width, S5K4ECGX_Driver.Preview_Height);
             break;

        case SENSOR_FEATURE_SET_AE_WINDOW:
             SENSORDB("[4EC] F_SET_AE_WINDOW\n");
             S5K4ECGX_AE_Set_Window(*pFeatureReturnPara32, S5K4ECGX_Driver.Preview_Width, S5K4ECGX_Driver.Preview_Height);
             break;

        case SENSOR_FEATURE_GET_AE_AWB_LOCK_INFO:
             SENSORDB("[4EC] F_GET_AE_AWB_LOCK_INFO\n");
             S5K4ECGX_get_AEAWB_lock((*pFeatureData64),*(pFeatureData64+1));
             break;
    ...
    //SENSORDB("S5K4ECGX_FeatureControl---\n");
    return ERROR_NONE;
...
{
    S5K4ECGX_Open,             // get sensor id, set initial setting to sesnor
    S5K4ECGX_GetInfo,          // get sensor capbility,
    S5K4ECGX_GetResolution,    // get sensor capure/preview resolution
    S5K4ECGX_FeatureControl,   // set shutter/gain, set/read register
    S5K4ECGX_Control,          // change mode to preview/capture/video
    S5K4ECGX_Close             // close, do nothing currently
};
