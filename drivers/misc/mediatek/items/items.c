...
#endif
	if(item_exist("items.kernel.test")) 
		printk("kernel items test : items exist Yes items.kernel.test\n");
	else
		printk("kernel items test : items exist Not items.kernel.test\n");
