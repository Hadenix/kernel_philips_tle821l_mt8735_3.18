...
static long items_dev_ioctl(struct file *file,unsigned int cmd, unsigned long arg)                       
{
...
static int items_dev_open(struct inode *fi, struct file *fp)
{
...
#endif
static ssize_t items_dev_read(struct file *filp, char *buf, size_t length, loff_t *offset)
{
#if 0
	unsigned long flags;
...
//static ssize_t items_dev_write(struct file *filp, const char __user *buf, size_t length, loff_t *offset)
//{
//    return 0;
//}
