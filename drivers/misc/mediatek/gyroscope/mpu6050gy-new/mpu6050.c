...
/*----------------------------------------------------------------------------*/
#define MPU6050GY_DEBUG 1
#define GYRO_FLAG					"<GYROSCOPE> "
#define GYRO_FUNC(f)       			printk(GYRO_FLAG"%s\n", __func__)
#define GYRO_ERROR(fmt, args...)	printk(GYRO_FLAG fmt, ##args)
#define GYRO_INFO(fmt, args...)		printk(GYRO_FLAG fmt, ##args)
#if MPU6050GY_DEBUG
#define GYRO_DBG(fmt, args...)		printk(GYRO_FLAG fmt, ##args);
//pr_debug(GYRO_FLAG fmt, ##args)
#else
...
static int __init mpu6050_init(void)
{
	...
	hw = get_gyro_items_func(name, hw); //Elink Nicholas Zheng add
