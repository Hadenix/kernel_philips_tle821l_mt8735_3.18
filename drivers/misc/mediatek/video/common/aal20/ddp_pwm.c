...
#if 1    //Elink_zhou@20160824
		int level_256 = 0;
		int bls_level_64 = 40;
	
		if(item_exist("LCM.backlight.level") == 1)
			bls_level_64 = item_integer("LCM.backlight.level",0); // 1 ~ 64
	
		if (bls_level_64 >= 64)
			bls_level_64 = 63;
	
		if((bls_level_64 > 0) && (level_1024 > 4))
			level_256 = ((level_1024 / 4) * bls_level_64)/64 + 10; 
		else
			level_256 = 0;
