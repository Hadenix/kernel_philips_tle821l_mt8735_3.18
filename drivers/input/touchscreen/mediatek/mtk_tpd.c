...
#if defined(CONFIG_TOUCHSCREEN_MTK_GSLX688)
#include "elink_devconfig_tp.h" 
	...
	|| defined(CONFIG_TOUCHSCREEN_SYNAPTICS_S3528) || defined(CONFIG_MTK_S7020)|| defined(CONFIG_TOUCHSCREEN_MTK_SSD614X)
...
#if defined(CONFIG_TOUCHSCREEN_MTK_GSLX688)
	Elink_tp_device_get(pdev); // elink_devconfig_tp.c
#endif
